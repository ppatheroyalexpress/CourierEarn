...
export default function PickupScreen() {
    ...
    const [houses, setHouses] = useState<string>('0');
    const [parcels, setParcels] = useState<string>('0');
    ...
    const total = Number(houses || 0) + Number(parcels || 0);
    ...
    const handleSave = async () => {
        ...
        if (total <= 0) {
            setMessage({ type: 'error', text: "Please enter at least one pickup." });
            return;
        }
        ...
        try {
            ...
            if (error) {
                ...
                setMessage({ type: 'success', text: "Saved pickup entry successfully!" });
                setHouses('0');
                setParcels('0');
            }
        } catch (err: any) {
    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Pickup Entry</Text>
                <View style={{ width: 40 }} />
            </View>
                ...
                <View style={styles.inputRow}>
                    <View style={styles.flex1}>
                        <Input
                            label="Pickup Houses"
                            value={houses}
                            onChangeText={setHouses}
                            keyboardType="numeric"
                        />
                    </View>
                    <View style={styles.flex1}>
                        <Input
                            label="Pickup Parcels"
                            value={parcels}
